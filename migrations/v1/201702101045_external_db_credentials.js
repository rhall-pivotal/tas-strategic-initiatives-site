exports.migrate = function(input) {
  ...
  if (properties['.properties.system_database']['value'] == 'external') {
    if (properties['.properties.system_database.external.username']['value'] != '') {
      ...
      properties['.properties.system_database.external.nfs_volume_username'] = properties['.properties.system_database.external.username']
      properties['.properties.system_database.external.nfs_volume_password'] = properties['.properties.system_database.external.password']
