...
const migration = require("../201901141011_prevent_upgrade_on_cf_metrics.js");
...
describe("Ensure deprecated 'cf' metrics name is not selected", function() {
  context("when enable_cf_metric_name is selected", function() {
    it("raises an error", function() {
      ...
      }).should.throw("Attempt to upgrade to PAS 2.5+ with the deprecated 'cf' metrics name selected. Please uncheck the 'Use \"cf\" as deployment name in emitted metrics' option in the Advanced Features tab before attempting to upgrade.");
    });
  });
