exports.migrate = function(input) {
  ...
  if( properties['.properties.networking_point_of_entry'] ) {
    if( properties['.properties.networking_point_of_entry']['value'] == 'terminate_at_router' ) {
      if( properties['.properties.networking_point_of_entry.terminate_at_router.ssl_ciphers']['value'] != null ) {
        var rfcCiphers = properties['.properties.networking_point_of_entry.terminate_at_router.ssl_ciphers']['value'].split(':')
