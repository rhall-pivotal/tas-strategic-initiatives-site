...
describe("Ensure route integrity is enabled", function() {
  ...
  context("when route integrity is disabled", function() {
    it("raises an error", function(){
      ...
      }).should.throw('attempt to upgrade to Isolation Segment 2.4+ with route integrity disabled, please enable route integrity prior to upgrade under "Router application identity verification" in "Application Containers"');
    });
  });
